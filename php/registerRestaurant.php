...
$taste = htmlentities($_REQUEST["taste"]);
...
|| empty($price) || empty($taste) || empty($imagePath)){
...
$result = $access->registerRestaurant($resName, $address, $latitude, $longitude, $city, $price, $taste, $imagePath);
if($result){
