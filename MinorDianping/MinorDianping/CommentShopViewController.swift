...
//    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let dbRating0 = Double(ratingControl.rating)
        let dbRating1 = Double(ratingControl1.rating)
        let dbRating2 = Double(ratingControl2.rating)
        let dbRating = (dbRating0 + dbRating1 + dbRating2) / 3
        ...
        // save comments, evaluation, evaluationNum in the server
        let nameForSQL: String = restaurant!.name!
        let evaluationInString = String(describing: restaurant!.evaluation)
        let evaluationNumInString = String(describing: restaurant!.evaluationNum)
